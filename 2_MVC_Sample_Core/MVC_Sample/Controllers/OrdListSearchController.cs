...
namespace MVC_Sample.Controllers
{
    ...
    public class OrdListSearchController : MyBaseMVControllerCore
    {
        /// <summary>
        ...
        /// </remarks>
        [HttpGet]
        public async Task<IActionResult> Index(OrdViewModel model, bool autoSearch = false)
        {
        ...
        public async Task<IActionResult> Search(OrdViewModel model)
        {
            model.PageIndex = 1;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Page(OrdViewModel model, int targetPage)
        {
        ...
        /// <returns>再描画（ViewResult）</returns>
        private async Task<IActionResult> SearchPage(OrdViewModel model, string message)
        {
