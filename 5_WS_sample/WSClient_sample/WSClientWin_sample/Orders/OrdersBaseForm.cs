//**********************************************************************************
//* トランザクション・テーブル（Orders）保守：共通フッタを持つ中間 BaseForm（Ｐ層）
//**********************************************************************************
...
namespace WSClientWin_sample.Orders
{
    ...
    /// </remarks>
    public class OrdersBaseForm : MyBaseControllerWin
    {
        ...
        private void InitializeFooter()
        {
            ...
            this.btnMain1 = OrdersBaseForm.CreateMainButton("btnMain1", 8);
            this.btnMain2 = OrdersBaseForm.CreateMainButton("btnMain2", 148);
            this.btnMain3 = OrdersBaseForm.CreateMainButton("btnMain3", 288);
            this.btnMain4 = OrdersBaseForm.CreateMainButton("btnMain4", 428);
            this.btnMain5 = OrdersBaseForm.CreateMainButton("btnMain5", 568);
            ...
            this.ddlServiceName.Items.Add(new ComboBoxItem("インプロセス呼出", "OrdersInProcess"));
            this.ddlServiceName.Items.Add(new ComboBoxItem("WCF TCPサービス呼出", "OrdersWCFTcp"));
            this.ddlServiceName.Items.Add(new ComboBoxItem("ASP.NET WebAPI呼出", "OrdersWebAPI"));
