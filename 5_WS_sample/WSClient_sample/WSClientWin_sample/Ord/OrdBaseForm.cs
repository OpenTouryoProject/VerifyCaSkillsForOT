//**********************************************************************************
//* 受注管理（Ord）：共通フッタを持つ中間 BaseForm（Ｐ層）
//**********************************************************************************
...
namespace WSClientWin_sample.Ord
{
    ...
    /// </remarks>
    public class OrdBaseForm : MyBaseControllerWin
    {
        ...
        private void InitializeFooter()
        {
            ...
            this.btnMain1 = OrdBaseForm.CreateMainButton("btnMain1", 8);
            this.btnMain2 = OrdBaseForm.CreateMainButton("btnMain2", 148);
            this.btnMain3 = OrdBaseForm.CreateMainButton("btnMain3", 288);
            this.btnMain4 = OrdBaseForm.CreateMainButton("btnMain4", 428);
            this.btnMain5 = OrdBaseForm.CreateMainButton("btnMain5", 568);
            ...
            this.ddlServiceName.Items.Add(new ComboBoxItem("インプロセス呼出", "OrdInProcess"));
            this.ddlServiceName.Items.Add(new ComboBoxItem("WCF TCPサービス呼出", "OrdWCFTcp"));
            this.ddlServiceName.Items.Add(new ComboBoxItem("ASP.NET WebAPI呼出", "OrdWebAPI"));
