...
namespace WSServer_sample.Dao
{
    ...
    public class DaoOrders : MyBaseDao
    {
        ...
        public DaoOrders(BaseDam dam, string cacheId) : base(dam)
        {
        ...
        #region クエリ メソッド
            ...
            protected void SetSqlFromFileOrCache(string sqlFileName)
            {
                ...
                else
                {
                    ...
                    if (DaoOrders.CDicQueryCache.ContainsKey(temp))
                    {
                        // キャッシュからSQL（Insert）を設定する。
                        this.SetSqlByCommand(DaoOrders.CDicQueryCache[temp]);
                    }
                    else
                    {
                        // ファイルからSQL（Insert）を設定する。
            ...
            protected void SetSqlToCache(string sqlFileName)
            {
                ...
                if (!string.IsNullOrEmpty(this.CacheId)
                    && !DaoOrders.CDicQueryCache.ContainsKey(temp))
                {
                    // クエリをキャッシュ
                    DaoOrders.CDicQueryCache[temp] = this.GetDam().DamIDbCommand.CommandText;
                }
            }
        ...
        {
            string sqlFileName = "DaoOrders_S1_Insert.sql";
        ...
        {
        	string sqlFileName = "DaoOrders_D1_Insert.xml";
        ...
        {
            string sqlFileName = "DaoOrders_S2_Select.xml";
        ...
        {
            string sqlFileName = "DaoOrders_D2_Select.xml";
        ...
        {
        	string sqlFileName = "DaoOrders_S3_Update.xml";
        ...
        {
        	string sqlFileName = "DaoOrders_D3_Update.xml";
        ...
        {
        	string sqlFileName = "DaoOrders_S4_Delete.xml";
        ...
        {
        	string sqlFileName = "DaoOrders_D4_Delete.xml";
        ...
        {
        	string sqlFileName = "DaoOrders_D5_SelCnt.xml";
