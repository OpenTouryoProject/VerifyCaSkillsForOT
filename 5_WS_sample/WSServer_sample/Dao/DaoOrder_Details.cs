...
namespace WSServer_sample.Dao
{
    /// <summary>自動生成Daoクラス</summary>
    public class DaoOrder_Details : MyBaseDao
    {
        ...
        public DaoOrder_Details(BaseDam dam, string cacheId) : base(dam)
        {
        ...
        protected void SetParametersFromHt()
        {
            ...
            {
                object obj = this.HtParameter[paramName];

                if (obj is DaoParam)
                {
                    DaoParam dp = (DaoParam)obj;
                    this.SetParameter(paramName, dp.Value, dp.DbType, dp.Size, dp.Direction);
                }
                else
                {
                    this.SetParameter(paramName, obj);
                }
            }
        }
        ...
        public object Quantity
        {
            set
            {
                this.HtParameter["Quantity"] = value;
            }
            get
            {
                return this.HtParameter["Quantity"];
            }
        }
        ...
        public object Discount
        {
            set
            {
                this.HtParameter["Discount"] = value;
            }
            get
            {
                return this.HtParameter["Discount"];
            }
        }
        ...
        /// <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
        public object Set_Quantity_forUPD
        {
            set
            {
                this.HtParameter["Set_Quantity_forUPD"] = value;
            }
            get
            {
                return this.HtParameter["Set_Quantity_forUPD"];
            }
        }
        ...
        /// <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
        public object Set_Discount_forUPD
        {
            set
            {
                this.HtParameter["Set_Discount_forUPD"] = value;
            }
            get
            {
                return this.HtParameter["Set_Discount_forUPD"];
            }
        }
        ...
        /// <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
        public object Quantity_Like
        {
            set
            {
                this.HtParameter["Quantity_Like"] = value;
            }
            get
            {
                return this.HtParameter["Quantity_Like"];
            }
        }
        ...
        /// <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
        public object Discount_Like
        {
            set
            {
                this.HtParameter["Discount_Like"] = value;
            }
            get
            {
                return this.HtParameter["Discount_Like"];
            }
        }
        ...
        #region クエリ メソッド
            ...
            protected void SetSqlFromFileOrCache(string sqlFileName)
            {
                ...
                else
                {
                    ...
                    if (DaoOrder_Details.CDicQueryCache.ContainsKey(temp))
                    {
                        // キャッシュからSQL（Insert）を設定する。
                        this.SetSqlByCommand(DaoOrder_Details.CDicQueryCache[temp]);
                    }
                    else
                    {
                        // ファイルからSQL（Insert）を設定する。
            ...
            protected void SetSqlToCache(string sqlFileName)
            {
                ...
                if (!string.IsNullOrEmpty(this.CacheId)
                    && !DaoOrder_Details.CDicQueryCache.ContainsKey(temp))
                {
                    // クエリをキャッシュ
                    DaoOrder_Details.CDicQueryCache[temp] = this.GetDam().DamIDbCommand.CommandText;
                }
            }
        ...
        {
            string sqlFileName = "DaoOrder_Details_S1_Insert.sql";
        ...
        {
        	string sqlFileName = "DaoOrder_Details_D1_Insert.xml";
        ...
        {
            string sqlFileName = "DaoOrder_Details_S2_Select.xml";
        ...
        {
            string sqlFileName = "DaoOrder_Details_D2_Select.xml";
        ...
        {
        	string sqlFileName = "DaoOrder_Details_S3_Update.xml";
        ...
        {
        	string sqlFileName = "DaoOrder_Details_D3_Update.xml";
        ...
        {
        	string sqlFileName = "DaoOrder_Details_S4_Delete.xml";
        ...
        {
        	string sqlFileName = "DaoOrder_Details_D4_Delete.xml";
        ...
        {
        	string sqlFileName = "DaoOrder_Details_D5_SelCnt.xml";
