...
namespace WSServer_sample.Dao
{
    ...
    public class DaoSuppliers : MyBaseDao
    {
        ...
        public DaoSuppliers(BaseDam dam, string cacheId) : base(dam)
        {
        ...
        public object HomePage
        {
            set
            {
                this.HtParameter["HomePage"] = value;
            }
            get
            {
                return this.HtParameter["HomePage"];
            }
        }
        ...
        /// <remarks>更新処理時のSET句で使用するパラメタ専用</remarks>
        public object Set_HomePage_forUPD
        {
            set
            {
                this.HtParameter["Set_HomePage_forUPD"] = value;
            }
            get
            {
                return this.HtParameter["Set_HomePage_forUPD"];
            }
        }
        ...
        /// <remarks>動的参照処理時のLIKE検索で使用するパラメタ専用</remarks>
        public object HomePage_Like
        {
            set
            {
                this.HtParameter["HomePage_Like"] = value;
            }
            get
            {
                return this.HtParameter["HomePage_Like"];
            }
        }
        ...
        #region クエリ メソッド
            ...
            protected void SetSqlFromFileOrCache(string sqlFileName)
            {
                ...
                else
                {
                    ...
                    if (DaoSuppliers.CDicQueryCache.ContainsKey(temp))
                    {
                        // キャッシュからSQL（Insert）を設定する。
                        this.SetSqlByCommand(DaoSuppliers.CDicQueryCache[temp]);
                    }
                    else
                    {
                        // ファイルからSQL（Insert）を設定する。
            ...
            protected void SetSqlToCache(string sqlFileName)
            {
                ...
                if (!string.IsNullOrEmpty(this.CacheId)
                    && !DaoSuppliers.CDicQueryCache.ContainsKey(temp))
                {
                    // クエリをキャッシュ
                    DaoSuppliers.CDicQueryCache[temp] = this.GetDam().DamIDbCommand.CommandText;
                }
            }
        ...
        {
            string sqlFileName = "DaoSuppliers_S1_Insert.sql";
        ...
        {
        	string sqlFileName = "DaoSuppliers_D1_Insert.xml";
        ...
        {
            string sqlFileName = "DaoSuppliers_S2_Select.xml";
        ...
        {
            string sqlFileName = "DaoSuppliers_D2_Select.xml";
        ...
        {
        	string sqlFileName = "DaoSuppliers_S3_Update.xml";
        ...
        {
        	string sqlFileName = "DaoSuppliers_D3_Update.xml";
        ...
        {
        	string sqlFileName = "DaoSuppliers_S4_Delete.xml";
        ...
        {
        	string sqlFileName = "DaoSuppliers_D4_Delete.xml";
        ...
        {
        	string sqlFileName = "DaoSuppliers_D5_SelCnt.xml";
