...
namespace MVC_Sample.Controllers
{
    ...
    /// </summary>
    [Authorize]
    public class OrdersAController : MyBaseMVController
    {
        /// <summary>
        /// 画面の初期表示
        /// GET: /OrdersA/
        ...
        [HttpGet]
        public ActionResult Index(OrdersViewModel model)
        {
            return View(model);
        }
        ...
        public async Task<ActionResult> SelectCount(OrdersViewModel model)
        {
            // ↓Ｂ層実行：Orders の件数確認------------------------------------
